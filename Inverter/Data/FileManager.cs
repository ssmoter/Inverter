    ...
    public class FileManager {
        ...
        public void SaveLog(string log) {
            try {
                ...
                LoggModel objLog = new LoggModel(DateTime.Now, log);
                log = JsonConvert.SerializeObject(objLog);
        ...
        public async Task<List<LoggModel>> LoadLog() {
            try {
                string filePath = $"{path}\\{logger}.txt";
                ...
                line = CreateJsonArrya(line);
                var result = JsonConvert.DeserializeObject<List<LoggModel>>(line);
                result.Reverse();
                return result;
            }
            catch (IOException ex) {
        ...
        private string CreateJsonArrya(string value) {
            value = "[" + value + "]";
